...
export function LoadingScreen() {
  ...
  return (
    <div className='fixed inset-0 z-50 flex flex-col items-center justify-center bg-[#121212] transition-opacity duration-300 p-4'>
      <div className='w-full max-w-md'>
        <Terminal className='border-[#444444]/30 bg-[#121212] shadow-lg max-h-[80vh] md:max-h-[450px] min-h-[300px] w-full'>
          ...
          <AnimatedSpan delay={3200} className='text-blue-500'>
            <span className='flex items-center'>
              ...
              <span className='text-xs text-[#898989]'>[node, react, next]</span>
            </span>
          </AnimatedSpan>
          ...
          <TypingAnimation delay={4000} duration={30} className='text-[#898989]'>
            Running final checks...
          </TypingAnimation>

          <AnimatedSpan delay={4800} className='text-[#898989] text-xs'>
          ...
          <AnimatedSpan delay={5400} className='text-green-500 font-bold'>
            <span>✓ Application ready!</span>
          </AnimatedSpan>

          <TypingAnimation delay={5800} duration={20} className='text-[#898989]'>
            Welcome to beny.one
          </TypingAnimation>
        </Terminal>
      </div>
      ...
      <div className='w-full max-w-md mt-4'>
        <div className='w-full bg-[#222222] h-1 rounded-full overflow-hidden'>
          <div className='bg-[#969696] h-full transition-all duration-200 ease-out' style={{ width: `${progress}%` }} />
        </div>
