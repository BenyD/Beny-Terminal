...
export function SpotifyNowPlaying() {
  ...
  if (isLoading && !spotifyData) {
    return (
      <div className="flex items-center gap-2">
        <svg
          className="h-3 w-3 animate-spin text-[#969696]"
        ...
        <span className="text-xs text-[#969696]">Loading Spotify...</span>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <span className="max-w-[150px] truncate text-xs text-green-500">
